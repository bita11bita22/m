"""
پنل مدیریت XRAY — FastAPI + Nginx + Reality + Multi-Transport
"""
...
# پورت‌های داخلی ترانسپورت‌های جدید
XRAY_GRPC_PORT = 18083
XRAY_HU_PORT   = 18084

# تنظیمات Reality (پورت مشترک برای Vision و XHTTP)
...
def make_links(uid: str, domain: str, label: str) -> dict:
    ...
    return {"ws": ws, "xhttp": xhttp, "grpc": grpc, "httpupgrade": httpupgrade, "reality": reality, "xhttp_reality": xhttp_reality}
