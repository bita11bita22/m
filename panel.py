"""
پنل مدیریت XRAY — FastAPI + Nginx + Reality + Multi-Transport (Stable 8 Configs)
"""
...
def make_links(uid: str, domain: str, label: str) -> dict:
    ...
    return {"ws": ws, "xhttp": xhttp, "grpc": grpc, "httpupgrade": httpupgrade, "trojan": trojan, "vmess": vmess, "reality": reality, "xhttp_reality": xhttp_reality}
