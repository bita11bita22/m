"""
پنل مدیریت XRAY — Reality Only + Beautiful UI + Telegram Bot
"""
...
XRAY_API_PORT = 10085
REALITY_PORT = 18443 # پورت داخلی برای Reality
...
async def stats_updater():
    ...
    while True:
        ...
        await asyncio.sleep(30) # هر ۳۰ ثانیه برای حفظ CPU
...
if __name__ == "__main__":
    ...
    # پایتون روی پورت اصلی (PORT) اجرا می‌شود
